...
album1 = Album.create(title: "Birds in the Trap Sing McKnight", release_date: "09/02/2016")
album2 = Album.create(title: "21", release_date: "04/20/2008")
...
song15 = Song.create(name: "Sweet Sweet", artist_id: artist3.id, album_id: album1.id)
song16 = Song.create(name: "Outside", artist_id: artist3.id, album_id: album1.id)
song17 = Song.create(name: "Goosebumps", artist_id: artist3.id, album_id: album1.id)
...
song3 = Song.create(name: "Lo Mein", artist_id: artist1.id, album_id: album3.id)
song13 = Song.create(name: "Baby Pluto", artist_id: artist1.id, album_id: album3.id)
song14 = Song.create(name: "P2", artist_id: artist1.id, album_id: album3.id)
...
song_bo = Song.create(name: "Prayer", artist_id: artist6.id, album_id: album7.id)
song_bo2 = Song.create(name: "Ava Marie", artist_id: artist6.id, album_id: album7.id)


song10 = Song.create(name: "Hello", artist_id: artist7.id, album_id: album8.id)

song18 = Song.create(name: "Start With Me", artist_id: artist8.id, album_id: album9.id)
...
old1 = Song.create(name: "Panini", artist_id: artist9.id, album_id: album10.id)
old2 = Song.create(name: "Kick It", artist_id: artist9.id, album_id: album10.id)
...
play3 = Playlist.create(name: "Greatest Hits")
